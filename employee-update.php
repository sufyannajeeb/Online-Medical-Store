...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id'])) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        echo "<p style='color:red;'>No employee found with ID = $id</p>";
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update'])) {
    ...
    $sex = mysqli_real_escape_string($conn, $_REQUEST['egender']);
    ...
    $sql = "UPDATE employee
            SET e_fname='$fname', e_lname='$lname', bdate='$bdate', e_age='$age', e_gender='$sex',
    ...
    if ($conn->query($sql)) {
        ...
        echo "<p style='color:red;'>Error! Unable to update: " . $conn->error . "</p>";
    }
}
			...
			<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
				<div class="column">
					...
					<p>
						...
						<input type="text" name="egender" value="<?php echo $row[5]; ?>">
					</p>
				</div>
				<div class="column">
					<p>
